[![GitHub Release Version](https://img.shields.io/github/v/release/django-files/ios-client?logo=github)](https://github.com/django-files/ios-client/releases/latest)
...
- New user setup/registration in app (0.3.X)
- Scan Login QR code direct from app support (0.3.X)
- Select an album from activity/share sheet (0.3.1)
- User invitation management and sign up (0.3.X)
- iOS Widget (0.4)
- Server Statistics (0.4)
