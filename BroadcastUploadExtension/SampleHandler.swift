...
//    Input  (host → ext):   StreamBroadcastConfig.swift keys
//    Output (ext → host):   "stream.broadcast.status" dict
//
...
final class SampleHandler: RPBroadcastSampleHandler {
    ...
    override func broadcastFinished() {
        ...
        // Use a semaphore to wait briefly so the RTMP FCUnpublish/close packets
        // get a chance to flush; otherwise the server may keep the stream "live"
