...
extension DFAPI {
    ...
    public func getShorts(page: Int = 1, filterUserID: Int? = nil, ordering: String? = nil, search: String? = nil, selectedServer: DjangoFilesSession? = nil) async throws -> ShortsResponse {
