...
extension DFAPI {
    ...
    func getAlbums(page: Int = 1, filterUserID: Int? = nil, ordering: String? = nil, search: String? = nil, selectedServer: DjangoFilesSession? = nil) async throws -> AlbumsResponse {
